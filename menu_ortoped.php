...
echo "<table width='100%' height='100%' border='0' cellpadding='0' cellspacing='0'>
  ...
  <tr>
			...
			<table width='100%' border='0' cellspacing='0' cellpadding='0'>
			  ...
			  <tr>
                <td><a href='pat_tooday_orto.php' class='menu2'>Пациенты на сегодня</a></td>
              </tr>
              <tr>
              ...
              <tr>
                <td><a href='pat_card_orto.php' class='menu2'>Работа с ортодонтическими картами</a></td>
              </tr>
</table>
			<table width='100%' border='0' cellspacing='0' cellpadding='0'>
                   <tr>
              ...
              <tr>
                <td><a href='doc_den_ch_per2.php' class='menu2'>Все пациенты</a></td>
              </tr>
			  			                 <td height='1' bgcolor='#42929D'><img src='image/transrerent.gif' width='1' height='1' /></td>
              </tr>
