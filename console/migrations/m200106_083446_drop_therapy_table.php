...
/**
 * Handles the dropping of table `{{%therapy}}`.
 */
class m200106_083446_drop_therapy_table extends Migration
{
    const TABLE_NAME = '{{%therapy}}';
    /**
     * {@inheritdoc}
     *
     */
    ...
    {
        if (Yii::$app->db->getTableSchema('{{%therapy}}', true) !== null) {

            $this->dropTable('{{%therapy}}');
        }
