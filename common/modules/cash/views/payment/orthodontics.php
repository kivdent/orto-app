...
$this->title = 'Пациенты на ортодонтическом лечении';
?>
<h1><?= $this->title ?></h1>
<?=
GridView::widget([
...
//        'MTel',
//        'DTel',
        'orthodonticsPayPerMonth',
        [
            'class' => 'yii\grid\ActionColumn',
            'template' => '{pay}',
            'buttons' => [
                'pay' => function ($url, $model, $key) {
                    return Html::a('Принять оплату', ['get-debt-orthodontics', 'patient_id' => $model->id], ['class' => 'btn btn-primary btn-xs']);
