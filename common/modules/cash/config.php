...
//            ['label' => 'Выдача денег old', 'url' => '/old_app/vid_deneg.php?step=1', 'roles' => ['recorder',]],
            ['label' => 'Выдача денег', 'url' => '/cash/manage/money-issue', 'roles' => ['recorder',]],
            ['label' => 'Начало смены', 'url' => '/cash/manage/start', 'roles' => ['recorder',]],
            ['label' => 'Закрытие смены', 'url' => '/cash/manage/end', 'roles' => ['recorder',]],
