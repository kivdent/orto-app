    ...
    'params' => [
        ...
        'menuItems' => [
           ...
           /// ['label' => 'Продажа гигиены', 'url' => '/old_app/pr_opl_hyg.php', 'roles' => ['recorder',]],
            ['label' => 'Продажа', 'url' => ['/invoice/manage/create','patient_id'=>0,'invoice_type'=>\common\modules\invoice\models\Invoice::TYPE_MATERIALS], 'roles' => ['recorder',]],
            ['label' => 'Оформить подарочный сертификат', 'url' => ['/invoice/manage/create','patient_id'=>0,'invoice_type'=>\common\modules\invoice\models\Invoice::TYPE_GIFT_CARDS], 'roles' => ['recorder',]],
