...
return [
    'params' => [
        //'entities' => [],
        'menuItems' => [
            ['label' => 'Продажа', 'url' => ['/invoice/manage/create', 'patient_id' => Patient::DEFAULT_ID, 'invoice_type' => \common\modules\invoice\models\Invoice::TYPE_MATERIALS], 'roles' => ['recorder','senior_recorder',]],
            ['label' => 'Оформить подарочный сертификат', 'url' => ['/invoice/manage/create', 'patient_id' => Patient::DEFAULT_ID, 'invoice_type' => \common\modules\invoice\models\Invoice::TYPE_GIFT_CARDS], 'roles' => ['recorder','senior_recorder',]],
