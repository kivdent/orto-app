...
<ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a href="#positions" aria-controls="positions" role="tab" data-toggle="tab">Позиции</a>
    </li>
    <li role="presentation"><a href="#allDoctors" aria-controls="allDoctors" role="tab" data-toggle="tab">Таблица по
            врачам</a></li>
</ul>
