$(document).ready(function () {
        ...
        function save_operation_compliance(operation_id) {
            ...
            if (count_invoice_items > 0) {
                ...
                if (button.data('type') === 'operation') {
                    action = "/catalogs/operation/save-ajax";
                    data = {
                        'operation_id': operation_id,
                        'items': items
                    };
                } else if (button.data('type') === 'completed_diagnoses') {
                    action = "/catalogs/completed-diagnoses/save-ajax";
                    data = {
                        'id': operation_id,
                        'items': items
                    }
        ...
        $('#invoice_form').on('show.bs.modal', function (event) {
            ...
            if (button.data('type') === 'completed_diagnoses') {
                $('#invoice-table-body').empty();
                count_invoice_items = 0;
                invoice_sum = 0;
                $("#summary").text('0 руб');
                ...
                var action = '/catalogs/completed-diagnoses/get-prices-items';
