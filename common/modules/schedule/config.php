...
//            ['label' => "Назначение пациентов new", 'url' => '/schedule/appointment', 'roles' => ['admin', 'therapist', 'orthopedist', 'surgeon', 'orthodontist', 'senior_recorder']],
            ['label' => "Назначение пациентов new", 'url' => '/schedule/appointment', 'roles' => ['recorder','admin','senior_recorder','therapist', 'orthopedist', 'surgeon', 'orthodontist',]],
            ...
            ['label' => 'Пациенты на сегодня new', 'url' => '/schedule/recorder', 'roles' => ['senior_recorder']],
