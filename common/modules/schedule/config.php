...
//            ['label' => 'Назначение пациентов олд', 'url' => '/old_app/naznach_pat.php', 'roles' => ['recorder','admin','senior_recorder',]],
            ['label' => 'Пациенты на сегодня old', 'url' => '/old_app/pat_tooday_reg.php', 'roles' => ['recorder',]],
            ['label' => 'Пациенты на сегодня', 'url' => '/schedule/recorder', 'roles' => ['recorder','senior_recorder']],
