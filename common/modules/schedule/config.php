...
return [
    'params' => [
        ...
        'menuItems' => [
            ...
            ['label' => 'Пациенты на сегодня', 'url' => '/old_app/pat_tooday_orto.php', 'roles' => ['orthodontist',]],
            ['label' => 'Пациенты на сегодня', 'url' => '/old_app/pat_tooday.php', 'roles' => ['therapist', 'orthopedist', 'surgeon',]],
