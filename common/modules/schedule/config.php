...
//            ['label' => 'Ежедневник', 'url' => '/old_app/raspis_show.php', 'roles' => ['admin', 'therapist', 'orthopedist', 'surgeon', 'orthodontist','radiologist',]],
            ['label' => 'Изменить расписание', 'url' => '/schedule/schedule', 'roles' => ['admin',]],
            ['label' => 'Назначение пациентов', 'url' => '/old_app/naznach_pat.php', 'roles' => ['admin', 'therapist', 'orthopedist', 'surgeon', 'orthodontist', 'recorder','senior_recorder',]],
            ['label' => 'Пациенты на сегодня', 'url' => '/old_app/pat_tooday_reg.php', 'roles' => ['recorder','senior_recorder',]],
...
//            ['label' => 'Табель', 'url' => '/old_app/tabel.php', 'roles' => ['admin', 'senior_nurse',]],
            ...
            ['label' => 'Табель', 'url' => '/schedule/time-sheet', 'roles' => ['accountant', 'director','admin', 'radiologist','recorder','senior_recorder','senior_recorder',]],
