...
if ($type == PriceListsWidget::TYPE_COMPLIANCE) {
                                            ...
                                            <?php foreach (PriceListsWidget::getItemsFromCategory($category->id, $type) as $pricelistItem): ?>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <?php elseif ($type == PriceListsWidget::TYPE_COMPLIANCE): ?>
                                                            <a href="#" class="manipulation-item"
                                                               id="<?= $pricelistItem->priceId ?>"
                                                               price="<?= $pricelistItem->price ?>">
                                                                <?= $pricelistItem->title ?>
                                                            </a>
                                                            <?php if ($pricelistItem->hasTechnicalItemCompliance()): ?>
                                                                <a href="#" class="manipulation-item">
                                                                    <?= '->'.$pricelistItem->technicalItemCompliance->title ?>
                                                                </a>
                                                                <?= Html::a('Изменить соответсвие',
                                                            ...
                                                            <?php else: ?>
                                                                ...
                                                                ['/pricelists/manage/set-compliance', 'pricelistItemId' => $pricelistItem->id],
                                                                ['class' => 'btn btn-success btn-xs set-compliance']
                                                            ) ?>
                                                            <?php endif ?>
                                                        ...
                                                        <?php else: ?>
                                                            <a href="#" class="manipulation-item"
                                                               id="<?= $pricelistItem->priceId ?>"
                                                               price="<?= $pricelistItem->price ?>"
                                                               pricelist-item-id="<?= $pricelistItem->id ?>">
                                                                <?= $pricelistItem->title ?>
                                                            </a>
                                                        <?php endif; ?>
                                                    </td>
...
if ($type == PriceListsWidget::TYPE_COMPLIANCE):
    ?>
    <div class="modal fade" id="modalCompliance" tabindex="-1" role="dialog" aria-labelledby=modalComplianceLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="modalComplianceLabel">Modal title</h4>
                </div>
                <div class="modal-body">
                    <?= PriceListsWidget::widget(['typePriceLists' => Pricelist::TYPE_TECHNICAL_ORDER,
