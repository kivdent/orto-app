...
echo "<a class='mmenu' target='_blanc' href=\"print.php?type=otch_d&podr=1\">Печать отчёта  ".$opl[2]['nazv']."</a><br />";
...
echo "<a class='mmenu' target='_blanc' href=\"print.php?type=otch_d&podr=2\">Печать отчёта  ".$opl[1]['nazv']."</a><br />";
echo "<hr width='100%' noshade='noshade' size='1'/>";
