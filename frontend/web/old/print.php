...
//msg ($c); 
	...
	echo "<br /><span class='feature3'>Расчёт по проценту от выручки</span><br />
		<table width='100%' border='1' cellpadding='1' cellspacing='0' bordercolor='#999999'>
  <tr>
    <td class='feature3'>Врач</td>
    <td class='feature3'>Сумма (баллы) за лечение</td>
    <td class='feature3'>Сумма (баллы) за хирургию</td>
    <td class='feature3'>Сумма (баллы) за ортодонтию</td>
    <td class='feature3'>Оплаты по схемам ортодонтии</td>
    <td class='feature3'>Оплаты до 01.11.2014</td>
  </tr>";
for ($i=0;$i<$c;$i++)
{
echo "<tr>";	

   echo " <td>".$sotr[$sotr_sp[$i]]['name']."</td>";
   echo " <td>".((array_sum($sotr[$sotr_sp[$i]]['lech_bal'])-$sotr[$sotr_sp[$i]]['lech_bal'][6]-$sotr[$sotr_sp[$i]]['lech_bal'][3])*$uet)." (".(array_sum($sotr[$sotr_sp[$i]]['lech_bal'])-$sotr[$sotr_sp[$i]]['lech_bal'][6]-$sotr[$sotr_sp[$i]]['lech_bal'][3]).")</td>";
    echo "<td>".($sotr[$sotr_sp[$i]]['lech_bal'][6]*$uet)." (".$sotr[$sotr_sp[$i]]['lech_bal'][6].")</td>";
    echo "<td>".($sotr[$sotr_sp[$i]]['lech_bal'][3]*$uet)." (".$sotr[$sotr_sp[$i]]['lech_bal'][3].")</td>";
    echo "<td>".$sotr[$sotr_sp[$i]]['orto']."</td>";
    echo "<td>".$sotr[$sotr_sp[$i]]['old']."</td>";
