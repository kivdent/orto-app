...
<link href="main2.css" rel="stylesheet" type="text/css" /><title>Орто-премьер. Пациенты на сегодня - Корчемный Владимир Маркович</title>
	</head>
	<body>
  ...
  <tr>
			...
			<table width='100%' border='0' cellspacing='0' cellpadding='0'>
              ...
              <tr>
                <td><a href='doc_den_per.php' class='menu2'>Отчёт за период</a></td>
              </tr>
              <tr>
                <td height='1' bgcolor='#42929D'><img src='image/transrerent.gif' width='1' height='1' /></td>
              </tr>
  ...
  <tr>
    <td><table width='100%' border='1' cellpadding='0' cellspacing='1' bordercolor="#000000" bgcolor='#FFFFFF'>
      <tr>
        <td>
