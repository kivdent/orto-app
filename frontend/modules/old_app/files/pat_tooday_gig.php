	  ...
	  <tr>
		...
		for ($i=0;$i<$countB;$i++)
		{
			...
			echo "<td class='alltext'>".$NN[0].":".$NN[1]."</td>
				<td class='alltext'><a href='pat_card.php?id=".$rowB['11']."&ro=0' class='menu2' target='_blank'>".$rowB['12']." ".$rowB['13']." ".$rowB['14']."</a><br>";
...
echo "<a href='pat_tooday_work_gig.php?step=4&pat=".$rowB['11']."&count=1' class='menu2'>Оплата</a><br />";	
echo "<a href='gig_index.php?pat=".$rowB['11']."' class='menu2'>Внести индексы</a>";	
